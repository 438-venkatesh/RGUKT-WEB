...
const CORE_HERO_CONFIGS: PageHeroConfig[] = [
  ...
  { ...hero('GoverningCouncil@RGUKT-AP'), match: '/administration/governing-council' },
  { ...hero('AcademicCouncil@RGUKT-AP'), match: '/administration/academic-council' },
  { ...hero('Directors@RGUKT-AP'), match: '/administration/directors' },
  { ...hero('CAO@RGUKT-AP'), match: '/administration/cao' },
  { ...hero('FinanceOfficer@RGUKT-AP'), match: '/administration/finance-officer' },
  { ...hero('SportsBoard@RGUKT-AP'), match: '/administration/sports-board' },
  {
  ...
  { ...hero('Medals@RGUKT-AP'), match: '/students/medals' },
  { ...hero('CareerGrowth@RGUKT-AP'), match: '/students/career-growth' },
  { ...hero('QuantumLab@RGUKT-AP'), match: '/students/quantum-lab' },
  { ...hero('AntiRagging@RGUKT-AP'), match: '/students/anti-ragging' },
  { ...hero('ICC@RGUKT-AP'), match: '/students/icc' },
  { ...hero('WomenEmpowerment@RGUKT-AP'), match: '/students/women-empowerment' },
  { ...hero('Cultural@RGUKT-AP'), match: '/students/cultural' },
  { ...hero('Sports@RGUKT-AP'), match: '/students/sports' },
  { ...hero('Community@RGUKT-AP'), match: '/students/community' },
  { ...hero('AlumniEngagement@RGUKT-AP'), match: '/students/alumni-engagement' },
