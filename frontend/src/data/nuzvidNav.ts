...
export const NUZVID_MENUS: NavMenu[] = [
  {
    ...
    items: [
      ...
      { label: 'Vision and Mission', href: '/nuzvid/about/vision-mission' },
      { label: 'At a Glance', href: '/nuzvid/about/at-a-glance' },
      ...
      { label: 'ARIIA 2021 Report', href: '/nuzvid/about/ariia-report' },
      { label: 'Right to Information Act', href: '/nuzvid/about/rti' },
      { label: 'NAAC Certificate', href: '/nuzvid/about/naac' },
      { label: 'Gallery', href: '/nuzvid/about/gallery' },
    ],
  },
  {
    key: 'academics',
