...
const centralLibrary: AcademicsPage = {
  ...
  icon: 'book',
  sourceUrl: 'https://www.rgukt.in/academics/facilities/central-library/',
  sourceStatus: 'unavailable',
  blocks: [
    {
      kind: 'lead',
      text: 'The Central Library system supports teaching, learning and research with print and digital collections across all RGUKT-AP campuses.',
    },
    { kind: 'stats', items: LIBRARY_STATS },
    {
      ...
      cols: 3,
      items: [
        { icon: 'book', title: LIBRARY_SERVICES[0], body: 'Borrow from the print collection and consult reference works at the circulation desk.' },
        { icon: 'laptop', title: LIBRARY_SERVICES[1], body: 'e-journals, online databases and full-text resources reachable from the campus network.' },
        { icon: 'link', title: LIBRARY_SERVICES[2], body: 'Titles held at one campus can be requested by readers at another.' },
        { icon: 'home', title: LIBRARY_SERVICES[3], body: 'Quiet reading space and individual carrels for extended study sessions.' },
        { icon: 'doc', title: LIBRARY_SERVICES[4], body: 'Archive of theses and dissertations submitted across the university.' },
        { icon: 'globe', title: LIBRARY_SERVICES[5], body: 'Daily newspapers and current periodicals in print.' },
      ],
    },
  ],
};
